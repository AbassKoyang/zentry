...
const Vault = () => {
    ...
    return (
        <section id='vault'  className={`px-10 py-24 lg:pt-52 bg-yellow-300 min-h-screen flex justify-center`}>
            <div className='flex items-center justify-between max-w-[1400px] overflow-x-hidden'>
            <div>
                
                <h1 id='vault-header' className='special-font font-zentry font-black opacity-1 text-6xl uppercase leading-[.8] text-black  md:text-[6rem]'>The Univ<b>e</b>rse <br />Powered By Ze<b>n</b>t</h1>
